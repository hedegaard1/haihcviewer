export const __webpack_esm_id__=394;export const __webpack_esm_ids__=[394];export const __webpack_esm_modules__={518(e,t,o){o.r(t),o.d(t,{IhcControllerElement:()=>u});var r=o(791),i=o(679),a=o(781),n=o(360),s=o(503),l=o(450),d=o(202),c=o(174),h=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var s=e.length-1;s>=0;s--)(i=e[s])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n},p=function(e,t,o,r){return new(o||(o=Promise))(function(i,a){function n(e){try{l(r.next(e))}catch(e){a(e)}}function s(e){try{l(r.throw(e))}catch(e){a(e)}}function l(e){var t;e.done?i(e.value):(t=e.value,t instanceof o?t:new o(function(e){e(t)})).then(n,s)}l((r=r.apply(e,t||[])).next())})};o(320),o(480),o(999),o(360),o(560);let u=class extends c.WF{static get styles(){return[i.RF,c.AH`
      ...
      <div id="controllercard">
        ...
        <div id="controllertab">
          ...
          <span id="headeractions">
            ${0==this.selectedtab?c.qy`
              <div id="reloadproject" @click=${this.onReloadProject}
                title="${(0,d.k)("reload_project_title")}">
                <ha-icon icon="mdi:refresh"></ha-icon>${(0,d.k)("reload_project")}
              </div>`:""}
            <slot name="header-actions"></slot>
          </span>
        </div>
      </div>`}fact(e,t,o=!1,r=null){return t?c.qy`<span class="factlabel">${e}</span><span
      class="factvalue ${o?"rare":""}" title="${r||t}">${t}</span>`:""}projectLine(e){return(null==e?void 0:e.lastmodified)?(0,d.k)("last_changed",this.readableTime(e.lastmodified)):""}projectRevision(e){return e?`${e.projectMajorRevision}.${e.projectMinorRevision}`:null}readableTime(e){return`${e}`.replace("T"," ").replace(/:\d\d$/,"")}groupCount(){if(null==this.ihcproject)return"";let e=0;for(let t of this.ihcproject.Groups)e+=t.Products.length;return(0,d.k)("rooms_products",this.ihcproject.Groups.length,e)}uptimeAsString(e){var t=parseInt(e)/1e3;if(isNaN(t))return"";var o=Math.floor(t/60/60/24),r=`${Math.floor((t-60*o*60*24)/60/60)} ${(0,d.k)("hours")}`;return o>0?`${o} ${(0,d.k)("days")} ${r}`:r}render_groups(){return null==this.ihcproject||this.isProjectLoading?"":this.visibleGroups().map(e=>c.qy`
    ...
    `)}visibleGroups(){return this.filtering()?this.ihcproject.Groups.filter(e=>(e.filtered||[]).length>0):this.ihcproject.Groups}filtering(){return""!==this.filterText.trim()||""!==this.filterProduct}render_filterbar(){return null==this.ihcproject||this.isProjectLoading?"":c.qy`
      ...
      </div>`}productNames(){if(null==this.ihcproject)return[];const e=new Set;for(let t of this.ihcproject.Groups)for(let o of t.Products)e.add(o.Name);return Array.from(e).sort((e,t)=>e.localeCompare(t))}resourceCount(){if(null==this.ihcproject)return 0;let e=0;for(let t of this.ihcproject.Groups)for(let o of t.Children)e+=(o.Children||[]).length;return e}clearFilter(){this.filterText="",this.filterProduct="",this.applyFilter()}applyFilter(){this.computeFilter(),this.clearSelection(),this.requestUpdate(),this.updateComplete.then(()=>this.openFiltered(this.filtering()))}computeFilter(){null!=this.ihcproject&&(this.filterHits=(0,l.lx)(this.ihcproject.Groups,this.filterText,this.filterProduct))}openFiltered(e){for(let t of this.groupNodes())t.requestUpdate(),t.expanded=e,t.updateComplete.then(()=>{for(let o of Array.from(t.shadowRoot.querySelectorAll("ihc-tree-node")))o.requestUpdate(),e&&(o.expanded=!0)})}constructor(){super(),this.isProjectLoading=!1,this.loadError=null,this.systemInfo=null,this.projectInfo=null,this.groupIcons=null,this.selected=null,this.onselected=null,this.offselected=null,this.filterText="",this.filterProduct="",this.filterHits=0,this.isProjectLoading=!1,this.loadError=null,this.ihcproject=null,this.ihcmapping=null,this.selectedtab=0}connectedCallback(){const e=Object.create(null,{connectedCallback:{get:()=>super.connectedCallback}});return p(this,void 0,void 0,function*(){e.connectedCallback.call(this),this.loadController()})}updated(e){const t=Object.create(null,{updated:{get:()=>super.updated}});return p(this,void 0,void 0,function*(){t.updated.call(this,e),null!=this.ihcproject&&this.ihcproject.Groups.map(e=>{var t=this.shadowRoot.getElementById(`group_${e.Id}`);t&&(t.data=e,t.chosenIcons=this.groupIcons)})})}onCardExpanded(e){var t;const o=null===(t=null==e?void 0:e.detail)||void 0===t?void 0:t.node;for(let e of this.groupNodes())e!==o&&e.collapse()}onNodeCollapsed(){this.clearSelection()}clearSelection(){this.selected&&(this.selected.selected=n.Selection.NotSelected,this.selected=null),this.onselected&&(this.onselected.selected=n.Selection.NotSelected,this.onselected=null),this.offselected&&(this.offselected.selected=n.Selection.NotSelected,this.offselected=null);var e=this.shadowRoot.getElementById("ihcproperties");e&&e.setSelected(null)}onPickIcon(e){var t,o;const r=null===(t=null==e?void 0:e.detail)||void 0===t?void 0:t.node;r&&this.shadowRoot.getElementById("icon-dlg").open(r.data.Id,r.data.Name,null===(o=this.groupIcons)||void 0===o?void 0:o[r.data.Id])}onIconChosen(){return p(this,void 0,void 0,function*(){const e=this.shadowRoot.getElementById("icon-dlg"),t=s.IHCManager.instance.get(this.controllerId);if(yield t.setGroupIcon(e.groupId,e.icon)){this.groupIcons=yield t.getGroupIcons();for(let e of this.groupNodes())e.chosenIcons=this.groupIcons,e.requestUpdate()}else this.loadError=(0,d.k)("icon_save_failed")})}groupNodes(){return null==this.ihcproject?[]:this.ihcproject.Groups.map(e=>this.shadowRoot.getElementById(`group_${e.Id}`)).filter(e=>null!=e)}onReloadProject(){return p(this,void 0,void 0,function*(){this.isProjectLoading||(yield this.loadController(!0))})}loadController(){return p(this,arguments,void 0,function*(e=!1){this.isProjectLoading=!0,this.loadError=null;try{const t=s.IHCManager.instance.get(this.controllerId);this.ihcmapping=yield t.getMapping();for(let e in this.ihcmapping)if("changed"in this.ihcmapping[e]){this.dispatchEvent(new CustomEvent("reloadneeded",{bubbles:!0,composed:!0}));break}this.groupIcons=yield t.getGroupIcons(),this.ihcproject=yield t.getProject(e),this.projectInfo=t.projectInfo,this.systemInfo=yield t.getSystemInfo(),this.ihcproject&&this.updateProject(this.ihcproject)}catch(e){this.loadError=`${e}`}finally{this.isProjectLoading=!1}})}onChanged(e){var t,o,r;null===(o=null===(t=e.detail)||void 0===t?void 0:t.wait)||void 0===o||o.push(this.refreshAfterReload()),!1===(null===(r=e.detail)||void 0===r?void 0:r.reloaded)&&this.dispatchEvent(new CustomEvent("reloadneeded",{bubbles:!0,composed:!0}))}refreshAfterReload(){return p(this,void 0,void 0,function*(){if(s.IHCManager.instance.get(this.controllerId).clearMapping(),this.ihcmapping=yield s.IHCManager.instance.get(this.controllerId).getMapping(),null!=this.ihcproject){this.updateProject(this.ihcproject);for(let t of this.ihcproject.Groups){var e=this.shadowRoot.getElementById(`group_${t.Id}`);e&&e.refresh()}if(this.selected){var t=this.shadowRoot.getElementById("ihcproperties");yield t.setSelected(this.selected)}}})}updateProject(e){for(let t of e.Groups){t.Children=[];for(let e of t.Products){t.Children.push(e),e.Children=[];for(let o of e.Inputs)e.Children.push(o),this.markResource(o,e,t),o.Product=e;for(let o of e.Outputs)e.Children.push(o),this.markResource(o,e,t),o.Product=e}for(let e of t.FunctionBlocks){t.Children.push(e),e.Children=[];for(let o of e.Inputs)e.Children.push(o),this.markResource(o,e,t);for(let o of e.Outputs)e.Children.push(o),this.markResource(o,e,t)}}this.ihcproject=e,this.computeFilter()}markResource(e,t,o){e.Parent=t,e.Group=o;const r=this.ihcmapping[e.Id];e.connected=void 0!==r,e.entity_id=(null==r?void 0:r.entity_id)||"",e.platform=(0,l.tj)(e.entity_id),e.friendlyName=this.friendlyName(e.entity_id)}friendlyName(e){var t,o,r;if(!e)return"";const i=null===(o=null===(t=s.IHCManager.instance.hass)||void 0===t?void 0:t.states)||void 0===o?void 0:o[e];return(null===(r=null==i?void 0:i.attributes)||void 0===r?void 0:r.friendly_name)||""}onSelectNode(e){return p(this,void 0,void 0,function*(){var t,o,r,i=this.shadowRoot.getElementById("ihcproperties"),s=null===(t=null==e?void 0:e.detail)||void 0===t?void 0:t.node;if(this.selected&&e.detail.shiftKey){if(this.selected==s)return!1;if(this.offselected)return!1;if(this.onselected){if(this.onselected==s)return!1;this.offselected=s,s.selected=n.Selection.OffIdSelected}else this.onselected=s,s.selected=n.Selection.OnIdSelected;return i.setSelected(this.selected,null===(o=this.onselected)||void 0===o?void 0:o.data.Id,null===(r=this.offselected)||void 0===r?void 0:r.data.Id),!1}return this.clearSelection(),null==s||(this.selected=s,this.selected.selected=n.Selection.Selected,s.data instanceof a.xC&&i.setSelected(this.selected)),!1})}selectTab(e){var t=e.target.attributes["data-tabid"].value;this.selectedtab=t}};h([(0,r.MZ)({type:Boolean,attribute:!0})],u.prototype,"show",void 0),h([(0,r.MZ)({type:String,attribute:!0})],u.prototype,"controllerId",void 0),h([(0,r.MZ)({type:Boolean,attribute:!1})],u.prototype,"isProjectLoading",void 0),h([(0,r.MZ)({type:String,attribute:!1})],u.prototype,"loadError",void 0),h([(0,r.MZ)({type:Object,attribute:!1})],u.prototype,"systemInfo",void 0),h([(0,r.MZ)({type:Object,attribute:!1})],u.prototype,"projectInfo",void 0),h([(0,r.MZ)({type:Object,attribute:!1})],u.prototype,"groupIcons",void 0),h([(0,r.MZ)({type:Object,attribute:!1})],u.prototype,"selected",void 0),h([(0,r.MZ)({type:Object,attribute:!1})],u.prototype,"onselected",void 0),h([(0,r.MZ)({type:Object,attribute:!1})],u.prototype,"offselected",void 0),h([(0,r.MZ)({type:Number,attribute:!1})],u.prototype,"selectedtab",void 0),h([(0,r.MZ)({type:String,attribute:!1})],u.prototype,"filterText",void 0),h([(0,r.MZ)({type:String,attribute:!1})],u.prototype,"filterProduct",void 0),h([(0,r.MZ)({type:Number,attribute:!1})],u.prototype,"filterHits",void 0),u=h([(0,r.EM)("ihc-controller")],u)}};
