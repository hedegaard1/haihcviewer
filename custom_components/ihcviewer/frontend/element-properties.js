export const __webpack_esm_id__=121;export const __webpack_esm_ids__=[121];export const __webpack_esm_modules__={999(e,t,i){i.r(t),i.d(t,{IhcPropertiesElement:()=>g});var o=i(791),n=i(805),s=i(522),a=i(503),r=i(360),d=i(781),l=i(958),c=i(202),h=i(450),p=i(174),u=function(e,t,i,o){var n,s=arguments.length,a=s<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(s<3?n(a):s>3?n(t,i,a):n(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a},v=function(e,t,i,o){return new(i||(i=Promise))(function(n,s){function a(e){try{d(o.next(e))}catch(e){s(e)}}function r(e){try{d(o.throw(e))}catch(e){s(e)}}function d(e){var t;e.done?n(e.value):(t=e.value,t instanceof i?t:new i(function(e){e(t)})).then(a,r)}d((o=o.apply(e,t||[])).next())})};i(805),i(17),i(531),i(348),i(805),i(560);let g=class extends p.WF{static get styles(){return[n.IhcResourceDialog.button_style,p.AH`
      :host {
        display: block;
    ...
    `]}render(){return this.working?p.qy`
      ...
      ${o&&this.suggestion()?p.qy`<div class="note">${this.suggestionReason()}</div>`:""}
      ...
      ${o||(null===(t=this.selected)||void 0===t?void 0:t.manual)||!(null===(i=this.selected)||void 0===i?void 0:i.entity_id)?"":p.qy`
        <div class="note">${(0,c.k)("automatic_help")}</div>`}`}addAction(e,t){var i;const o=("light"===t||"switch"===t)&&this.isInput()&&"bool"===(null===(i=this.selected)||void 0===i?void 0:i.type),n=this.suggestion(),s=n?t!==n:o;return p.qy`
      <div class="action">
        <button class="${s?"other":""}"
          @click=${()=>{this.showDialog(e)}}>${(0,r.platformLabel)(t)}</button>
        <div class="note">${(0,c.k)(`add_${t}_help`)}</div>
        ${o?p.qy`<div class="note">${(0,c.k)("add_writes_input")}</div>`:""}
      </div>`}suggestion(){var e,t;const i=null===(e=this.selectednode)||void 0===e?void 0:e.data,o=(0,h.eZ)(null===(t=this.selected)||void 0===t?void 0:t.type,!!(null==i?void 0:i.IsLightLevel),null==i?void 0:i.Product,this.isInput());return{binary_sensor:this.action_binary_sensor,light:this.action_light,sensor:this.action_sensor,switch:this.action_switch}[o]?o:""}suggestionReason(){var e,t;const i=null===(e=this.selectednode)||void 0===e?void 0:e.data;return(null==i?void 0:i.IsLightLevel)?(0,c.k)("suggest_light_level"):(0,c.k)("suggest_product",null===(t=null==i?void 0:i.Product)||void 0===t?void 0:t.Name)}renderValueActions(){return"bool"==this.selected.type?p.qy`<span class="valueactions">
